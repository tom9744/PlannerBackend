...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, email, name, birthday, password=None):
        """ 유저를 생성할 때 호출되는 메소드 """
        if not email:
    ...
    def create_superuser(self, email, name, birthday, password):
        """ 슈퍼유저를 생성하는 메소드 """
        user = self.create_user(email, name, birthday, password)
