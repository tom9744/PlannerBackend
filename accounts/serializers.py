...
class CustomUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'email', 'name', 'birthday', 'password', 'password_confirm', )
        read_only_fields = ('id', )
    ...
    def validate_birthday(self, value):
        ...
        if (today - value).days < 6570:
            raise serializers.ValidationError("만 18세 이하는 가입할 수 없습니다.")
        return value
